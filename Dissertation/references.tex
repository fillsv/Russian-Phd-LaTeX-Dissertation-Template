...
\bibliography{Dissertation/reference}
%
...
%М.Ю. Бражников, Г.В. Колмаков, А.А. Левченко, Л.П. Межов-Деглин, %Капиллярная турбулентность на поверхности жидкого водорода, 
%// Письма в ЖЭТФ, том 73, вып 8, стр 443-446 (2001).
%
%\bibitem{BrazhnikovWater}
%M.Y. Brazhnikov, G.V. Kolmakov, A.A. Levchenko, L.P. Mezhov-Deglin, %Observation of capillary turbulence on the water surface in a wide range of frequencies, 
%// Europhys. Lett. 58 (4), 510-516 (2002) 
%
%\bibitem{Abdurakhimov2007}
%L. V. Abdurakhimov, M. Yu. Brazhnikov, G. V. Kolmakov, A. A. Levchenko, and L. P. Mezhov-Deglin, %«Turbulence of capillary waves on the surface of quantum liquids», 
...
%
%\bibitem{Kolmakov2006}
%G.V. Kolmakov, M.Yu. Brazhnikov, A.A. Levchenko, A.N. Silchenko, P.V.E. McClintock, L.P. Mezhov-Deglin, Journal of Low Temperature Physics, Vol. 145, pp. 311-335, 2006
%
%\bibitem{addLowFreq}
...
%М.Ю. Бражников, Г.В. Колмаков, А.А. Левченко, Л.П. Межов-Деглин,% Изменение граничной частоты инерционного интервала тербулентности капиллярных волн на поверхности жидкого водорода. 
...
%
%
%\bibitem{FalkovichBook}
%Г. Фалькович, Современная гидродинамика - М.-Ижевск: НИЦ "Регулярная и хаотическая динамика", (2014)
%
%
%\bibitem{Brazhnikov_liq_hydr}
%Бражников М.Ю., Колмаков, Г.В., Левченко А.А.,
%% Турбулентность капиллярных волн на поверхности жидкого водорода 
%// ЖЭТФ. 2002. V. 122. P. 521.
%
%\bibitem{Ryzhenkova}
%Ryzhenkova I.V., Falkovich G.E., 
%%Effect of dissipation on the structure of a stationary wave turbulence spectrum 
...
%\bibitem{Babiano1995}
%Babiano A., Frick P.
%% Dubralle B. Scaling properties of numerical two-dimensional turbulence 
%// Physical Review E, 1995. Vol. 52. N. 4. P. 3719-3729. 
%
%\bibitem{Babiano1987}
%Babiano A., Basdevant C, Legras В., Sadourny P.
%% Voracity and passive-scalar dynamics in two-dimensional turbulence 
%// J. Fluid Mechanics. 1987. Vol. 183. P. 379-397
%
%
%\bibitem{Falcovich1988}
%Г.Е. Фалькович, А.Б. Шафаренко, ЖЭТФ, 94, 172, (1988)
%
%\bibitem{Pushkarev1996}
